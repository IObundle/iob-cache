...
let
  py2hwsw_commit = "635fa6c0b4bfcd611a1a536115546f2a6282c5e3"; # Replace with the desired commit.
  py2hwsw_sha256 = "Z/0TSIsHiNWXSU278D4UBLt6Avp2JrpnxD59xfWzdAw="; # Replace with the actual SHA256 hash.
