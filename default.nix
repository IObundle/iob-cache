...
let
  py2hwsw_commit = "ecd93cd18f64eeea8bb19a33f8e5bbe4916ec44b"; # Replace with the desired commit.
  py2hwsw_sha256 = "Cvny5y7l8NnVp23Jpp9Z8aypZEfFZSEv0pOKqgbcuTE="; # Replace with the actual SHA256 hash.
