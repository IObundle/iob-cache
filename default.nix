...
let
  py2hwsw_commit = "127bdded28f97b8f4b2ab700d4c1a26131b2e216"; # Replace with the desired commit.
  py2hwsw_sha256 = "+ZFrHz7yQLolpHd4DaosvIfDm7iYYXCGTivkfIaka+Y="; # Replace with the actual SHA256 hash.
